...
Import your WooCommerce Product with Import. 

== Description ==

Import Woocommerce enables to import WooCommerce Products, Post and Page. Imports inline and featured image along with the imported module.
...
Please show your support for Import Woocommerce by giving it a [rating](https://wordpress.org/support/view/plugin-reviews/import-woocommerce?rate=5#postform) :)
